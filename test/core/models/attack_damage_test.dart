...
void main() {
  group("Attack calcDamage", () {
    ...
    test("Teste de Ataque da Água contra o Fogo", () {
      ...
      double multiplicadorMedio =
          alvo.elementos
              .map(
                (elemento) =>
                    ElementMap.multiplicadores[atacante]?[elemento] ?? 1.0,
              ) // Cria uma Lista com o Multiplicador de CADA ELEMENTO
              .reduce((a, b) => a + b) /
          alvo
              .elementos
              .length; // Transforma essa lista em um único valor (uma soma), e em seguida divide pela quantidade deles
    ...
    test("Teste com Criatura de Vários Elementos", () {
      ...
      double multiplicadorMedio =
          alvo.elementos
              .map(
                (elemento) =>
                    ElementMap.multiplicadores[ataqueNeutro
      ...
      expect(
        dano,
        equals(10 * multiplicadorMedio),
        reason: "A iteração está incorreta",
      );
    });
  });
}
